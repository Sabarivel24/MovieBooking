...
// ensure your .env file is in .gitignore and contains STRIPE_SECRET_KEY


const CLIENT_URL = "http://localhost:5173";
const STRIPE_SECRET_KEY = process.env.STRIPE_SECRET_KEY; // stripe key is read from environment variable
